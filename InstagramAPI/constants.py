...
EXPERIMENTS = 'ig_promote_reach_objective_fix_universe,ig_android_universe_video_production,' \
              ...
              'ig_android_search_people_tag_universe,ig_android_react_native_ota,' \
              'ig_android_enable_concurrent_request,ig_android_react_native_stories_grid_view,' \
              'ig_android_business_stories_inline_insights,ig_android_log_mediacodec_info,' \
              'ig_android_direct_expiring_media_loading_errors,ig_video_use_sve_universe,' \
              'ig_android_cold_start_feed_request,ig_android_enable_zero_rating,ig_android_reverse_audio,' \
              'ig_android_branded_content_three_line_ui_universe,ig_android_live_encore_production_universe,' \
              'ig_stories_music_sticker,ig_android_stories_teach_gallery_location,' \
              'ig_android_http_stack_experiment_2017,ig_android_stories_device_tilt,' \
              'ig_android_pending_request_search_bar,ig_android_fb_topsearch_sgp_fork_request,' \
              'ig_android_seen_state_with_view_info,ig_android_animation_perf_reporter_timeout,' \
              'ig_android_new_block_flow,ig_android_story_tray_title_play_all_v2,ig_android_direct_address_links,' \
              ...
              'ig_android_video_keep_screen_on,ig_android_ad_leadgen_relay_modern,ig_android_profile_photo_as_media,' \
              'ig_android_insta_video_consumption_infra,ig_android_ad_watchlead_universe,' \
              'ig_android_direct_prefetch_direct_story_json,ig_android_shopping_react_native,' \
              'ig_android_top_live_profile_pics_universe,ig_android_direct_phone_number_links,' \
              'ig_android_stories_weblink_creation,ig_android_direct_search_new_thread_universe,' \
              'ig_android_histogram_reporter,ig_android_direct_on_profile_universe,ig_android_network_cancellation,' \
              ...
              'ig_android_mas_sticker_upsell_dialog_universe,ig_android_ad_add_per_event_counter_to_logging_event,' \
              ...
              'ig_android_live_notification_control_universe,ig_android_analytics_logger_running_background_universe,' \
              'ig_android_save_all,ig_android_reel_viewer_data_buffer_size,ig_direct_quality_holdout_universe,' \
              ...
              'ig_android_ad_watchinstall_universe,ig_android_ad_viewability_logging_universe,ig_android_new_optic,' \
              'ig_android_direct_visual_replies,ig_android_stories_search_reel_mentions_universe,' \
              'ig_android_threaded_comments_universe,ig_android_mark_reel_seen_on_Swipe_forward,' \
              'ig_internal_ui_for_lazy_loaded_modules_experiment,ig_fbns_shared,ig_android_capture_slowmo_mode,' \
              'ig_android_live_viewers_list_search_bar,ig_android_video_single_surface,ig_android_offline_reel_feed,' \
              'ig_android_video_download_logging,ig_android_last_edits,ig_android_exoplayer_4142,' \
